...
const mensagensDeErro = {
    ...
    email: {
        valueMissing: 'Por favor, digite seu e-mail.',
    ...
    dataNascimento: {
        valueMissing: 'Por favor, informe sua data de nascimento.',
        customError: 'Você precisa ter mais de 18 anos para se cadastrar.'
    },
    cpf: {
        valueMissing: 'Você precisa informar seu CPF para continuar.',
        customError: 'O CPF informado não é válido.'
    },
    cep: {
        valueMissing: 'Por favor, digite seu CEP para continuar.',
